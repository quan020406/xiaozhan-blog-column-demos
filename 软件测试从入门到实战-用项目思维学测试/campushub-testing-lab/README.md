...
![CampusHub Testing Lab 首页预览](./docs/images/homepage-smoke.png)
...
更多字段说明见 [API 契约](./docs/api-contract.md)。
...
| 学习路线映射 | `docs/learning-map.md` |
| 演示账号 | `docs/demo-accounts.md` |
| 常见问题 | `docs/faq.md` |
| 贡献说明 | `docs/contribution-guide.md` |
